...
#include <funciones.h>
#include <adc.h>                          // Funciones para leer el voltaje de la bateria.
...
void lecturaDatos()
{
  ...
  datosCayenne.addAnalogInput(2, ADC_BateriaLeerVoltaje()); //Batería en Voltios.
#if defined(DEBUG)
